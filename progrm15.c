 #include <stdio.h>
    ...
    int main()
    {
        ...
        root = new_node('4'); // making a new node

        root->left_child = new_node('1'); //left child of root

        root->right_child = new_node('6'); //right child of root

        root->left_child->left_child = new_node('5'); // new node

        root->left_child->right_child = new_node('2'); // new node
